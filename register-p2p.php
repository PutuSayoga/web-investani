...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Daftar | Peer to Peer Investani</title>
                ...
                <div class="navbar-main">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="index.html"><img src="https://investani.s3.amazonaws.com/assets/images/ptpnx-logo.png" alt=""></a>
                        </div>
         	...
         	<div class="container zoomIn animated">
                    <div align="center">
                        <form class="form-register">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <select id="kategori_daftar" class="form-control">
                                        <option value="user4">Vendor</option>
                                        <option value="user5">Lender</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <a href="index.html" class="btn btn-primary pull-right" name="register">Daftar
                                    </a>
                                </div>
                            </div>
                        </form>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
		  ...
		  <div class="row">
							...
							<a href="login-cf.html"><img src="https://investani.s3.amazonaws.com/assets/images/ptpnx-logo.png"><div>CrowdFunding</div></a>
                            </div>
                            <div class="form-group col-md-6">
							<a href="login-p2p.html"><img src="https://investani.s3.amazonaws.com/assets/images/ptpnx-logo.png"><div>Peer to Peer</div></a>
                            </div>
                        </div>
          </div>
        </div>
