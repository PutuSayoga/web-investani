                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse pull-right">
                            <ul class="nav navbar-nav">
                                <li><a class="is-active" href="index.php">Beranda</a></li>
                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <h4 class="carousel-subtitle bounceInUp animated slow ">SOLUSI TEKNOLOGI FINANSIAL BAGI PETANI</h4>
                        </div>
                        <!-- /.carousel-caption -->
                    </div>
                </div>
                ...
                <div class="item ">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <h4 class="carousel-subtitle bounceInUp animated slow">AYO GOTONG ROYONG UNTUK MEMBANTU PETANI INDONESIA MENGOLAH LAHAN MEREKA</h4>
                        </div>
                        <!-- /.carousel-caption -->
                    </div>
                </div>
                ...
                <div class="item ">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <h4 class="carousel-subtitle bounceInUp animated slow">MUDAHNYA MENDAPAT DANA PINJAMAN UNTUK LAHAN ANDA</h4>
                        </div>
                        <!-- /.carousel-caption -->
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="about-us-col">
                            ...
                            <div class="col-details">
                                <p>Daftarkan diri Anda. Jika Anda sudah mempunyai akun, login terlebih dahulu.</p>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="about-us-col">
                            ...
                            <div class="col-details">
                                <p>Pilih proyek yang ingin Anda investasikan. Anda juga bisa membuka proyek sesuai keinginan Anda.</p>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="about-us-col">
                            ...
                            <div class="col-details">
                                <p>Lengkapi semua syarat yang telah ditetapkan.</p>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="about-us-col">
                            ...
                            <div class="col-details">
                                <p>Nikmati keuntungan dari proyek yang Anda pilih.</p>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-offset-2">
                    <h3><strong>Apa Kata Mereka?</strong></h3>
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <div class="row" style="padding: 20px">
                                    ...
                                    <p class="testimonial_para">Dengan investani para pemilik lahan tidak lagi sulit untuk mendapatkan dana yang dibutuhkan. Pendanaan dapat dicapai dengan sistem crowdfunding atau peer to peer.</p>
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-2">
                            ...
                            <div class="item">
                                <div class="row" style="padding: 20px">
                                    <button style="border: none;"><i class="fa fa-quote-left testimonial_fa" aria-hidden="true"></i></button>
                                    <p class="testimonial_para">Saya merasa sangat terbantu dengan investani, sebab sekarang untuk mendapatkan dana ratusan juta tidak lagi sesulit dulu. Terimakasih investani.</p>
                                    <br>
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <img src="assets/images/team/team.png" class="img-responsive" style="width: 80px">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <h5><strong>Petani Indonesia</strong></h5>
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="donateModalLabel">
                            <center>MASUK</center>
                        </h4>
                    </div>
                    <div class="modal-body">
