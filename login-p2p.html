      ...
      <div class="modal-dialog">
        <div class="modal-content">
		  ...
		  <div class="row">
							...
							<a href="register-cf.html"><img src="assets/images/ptpnx-logo.png"><div>CrowdFunding</div></a>
                            </div>
                            <div class="form-group col-md-6">
							<a href="register-p2p.html"><img src="assets/images/ptpnx-logo.png"><div>Peer to Peer</div></a>
                            </div>
                        </div>
          </div>
        </div>
