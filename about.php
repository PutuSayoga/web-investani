...
<html class="no-js">
    <head>
        <meta charset="utf-8">
        <title>Tentang Kami | Investani</title>
              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li><a class="is-active" href="about.php">Tentang Kami</a></li>
                    </li>
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">Tentang Kami <span class="title-under"></span></h1>
		...
		<div class="container">
			...
			<div class="row fadeIn animated">
				...
				<div class="col-md-6">
					...
					<h2 class="title-style-2">TENTANG INVESTANI <span class="title-under"></span></h2>

					<p>
						Investani adalah platform investasi berbasis crowdfunding.
					</p>
