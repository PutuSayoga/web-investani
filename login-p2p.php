                        ...
                        <form class="form-login">
                            <div class="row">
                                <div class="form-group col-md-12 ">
                                    <input type="text" class="form-control" placeholder="Nama Pengguna" name="uname" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-12 ">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <a href="index.html" class="btn btn-primary pull-right" name="login">Masuk
                                    </a>
                                    <label>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
		  ...
		  <div class="row">
							...
							<a href="register-cf.html"><img src="https://investani.s3.amazonaws.com/assets/images/ptpnx-logo.png"><div>CrowdFunding</div></a>
                            </div>
                            <div class="form-group col-md-6">
							<a href="register-p2p.html"><img src="https://investani.s3.amazonaws.com/assets/images/ptpnx-logo.png"><div>Peer to Peer</div></a>
                            </div>
                        </div>
          </div>
        </div>
